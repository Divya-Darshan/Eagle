...
const START_GAP_SIZE := 400       # initial vertical gap
const MIN_GAP_SIZE := 200         # minimum gap (hardest difficulty)
const PIPE_SPEED := -200.0        # move left speed
const SPAWN_INTERVAL := 2.0       # seconds between spawns
const SPAWN_OFFSET_X := 400       # how far in front of camera pipes appear
